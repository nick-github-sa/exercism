...
def value_of_ace(card_one, card_two):
    ...
    # If either card is an Ace OR total already > 10, the new Ace must be 1.
...
def can_double_down(card_one, card_two):
    ...
    if 'A' in (card_one, card_two):
        alt_total = total + 10   # +10 because Ace already counted as 1
        return total in {9, 10, 11} or alt_total in {9, 10, 11}
